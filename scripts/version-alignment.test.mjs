...
test('release-facing version metadata stays aligned', () => {
  ...
  const exact = [
    ...
    ['desktop/sage-shell/src/control.rs', 'matches!(minor, Some(10..=20))'],
    ['scripts/stage-native-shell-daemon.sh', 'through v11.20.x semver'],
    ...
    ['docs/UPGRADING.md', `| v${version} | Indeterminate broadcast outcomes are reported honestly`],
