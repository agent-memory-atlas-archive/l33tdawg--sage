...
test('release-facing version metadata stays aligned', () => {
  ...
  const exact = [
    ...
    ['desktop/sage-shell/src/control.rs', 'matches!(minor, Some(10..=21))'],
    ['scripts/stage-native-shell-daemon.sh', 'through v11.21.x semver'],
    ...
    ['docs/UPGRADING.md', `| v${version} | The 11.21 line opens with the shell that admits it`],
