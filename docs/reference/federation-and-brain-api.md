<!-- Verified against SAGE v11.20.0 code (2026-09-02). Cite file:line when behavior is non-obvious. This doc covers the v11 federation and brain graph surface; rest-api.md governs the core /v1/* endpoints. -->
...
### Federation connectome and operator activity (v11.20.0)
